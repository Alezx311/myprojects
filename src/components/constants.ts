...
export const INITIAL_STATES: InitialStates = {
  NOTE_OCTAVE: 2,
  NOTE_DURATION: '4n',
  NOTE_VELOCITY: 0.8,
  MELODY_KEY: 'C',
  MELODY_SCALE: 'minorpentatonic',
  MELODY_SIZE: 4,
  MELODY_PARTS: 4,
  GUITAR_STRINGS: 6,
  GUITAR_FRETS: 24,
  GUITAR_TUNING: 'E Standart',
  PLAYER_INSTRUMENT: 'guitar-steel',
  PLAYER_SYNTH: 'PolySynth',
  PLAYER_BPM: 120,
  PLAYER_PLAYBACK_RATE: 1
}
...
export const GUITAR_TUNINGS: object = {
...
export const SYNTH_NAMES: string[] = [
  'AMSynth',
  'FMSynth',
  'DuoSynth',
  'MembraneSynth',
...
export const INSTRUMENT_NAMES: string[] = Object.keys(INSTRUMENTS)
